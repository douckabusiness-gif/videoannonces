...
const badges = [
    {
        ...
        criteria: {
            manual: true,
            description: 'Vérification manuelle par admin',
        },
    },
    {
    ...
    },
    {
        ...
        criteria: {
            responseTime: 1,
            description: 'Temps de réponse moyen < 1h',
        },
    },
    {
    ...
    },
    {
        ...
        criteria: {
            minRating: 4,
            minReviews: 10,
            description: 'Minimum 10 avis, tous positifs (≥4 étoiles)',
        },
    },
    {
        ...
        criteria: {
            manual: true,
            description: 'Attribution manuelle pour expertise',
        },
    },
];
