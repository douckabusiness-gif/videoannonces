 ...
 * Lance ce script avec: node make-admin.js
 */
...
async function main() {
    ...
    console.log('Options:');
    console.log('  1. Promouvoir le premier utilisateur (le plus récent)');
    console.log('  2. Promouvoir TOUS les utilisateurs');
    console.log('  3. Manuel (modifier le script)\n');

    // Par défaut, on promeut le premier utilisateur (le plus récent)
